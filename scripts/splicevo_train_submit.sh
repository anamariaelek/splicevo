...
DATA_TRAIN_DIR=${HOME}/sds/sd17d003/Anamaria/splicevo/data/splits_smallest/human_mouse_rat/train/
MODEL_DIR=${HOME}/sds/sd17d003/Anamaria/splicevo/models/smallest_human_mouse_rat_weighted_mse/
